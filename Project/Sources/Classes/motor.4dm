...
Function autoConnect($client : Object; $userParam) : Object
	...
	var $cmd; $error; $input; $output; $root; $xml : Text
	var $infos; $result : Object
	var $4DLink : 4D:C1709.File
	...
	$4DLink:=This:C1470.root.file("autoconnect.4DLink")
	$4DLink.setText($xml)
	...
	Case of 
		...
		: (Is Windows:C1573)
			...
			$cmd:=$client.path+" "+Char:C90(Double quote:K15:41)+$4DLink.platformPath+Char:C90(Double quote:K15:41)
